...
- Pause kiné (voir profil.pause_kine) : pendant ces dates, ne propose JAMAIS d'exercice qui sollicite les épaules ou les bras (tirages, développés, curls, triceps, pompes, gainage sur les bras, haltères tenus en main). Utilise les exercices sans charge sur le haut du corps : hip-thrust, presse-cuisses, leg-curl, leg-extension, mollets-assis, abduction-machine, kickback-poulie, hyperextension, pont-unilateral, fentes-bulgares-pdc, releve-jambes, dead-bug.
